package Home_Mathematics.Quaternions is
   ...
   function Generic_Quaternion_Matrix4_Conversion_Function (Q : Quaternion) return Matrix4;

   generic
      type Matrix3_Index is range <>;
      type Quaternion_Index is range <>;
      type Element is digits <>;
      type Quaternion is array (Quaternion_Index) of Element;
      type Matrix3 is array (Matrix3_Index, Matrix3_Index) of Element;
   function Generic_Quaternion_Matrix3_Conversion_Function (Q : Quaternion) return Matrix3;
